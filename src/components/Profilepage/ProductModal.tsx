...
function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  // Initialize configuration selection
  useEffect(() => {
  ...
  // Get current configuration or use product data directly
  ...
  useEffect(() => {
    // Reset finish when config changes
    setSelectedFinish(0);
  }, [selectedConfigId]);
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            ...
            {/* Tech Spec Table - Show all specs for current configuration */}
