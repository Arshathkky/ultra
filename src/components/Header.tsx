          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <div className="relative dropdown">
              ...
              {openDropdown === "products" && (
                <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg border border-gray-200 z-50">
                  <Link to="/profile" className="block px-4 py-2 text-gray-800 hover:bg-blue-100" onClick={handleLinkClick}>Profiles</Link>
        ...
        <div className="md:hidden bg-white shadow-md">
          <div className="container mx-auto px-4 py-4 space-y-2">
            ...
            <div className="relative dropdown">
              ...
              {openDropdown === "products" && (
                <div className="mt-1 space-y-2 pl-4">
                  <Link to="/profile" className="block text-gray-800 hover:text-blue-600 py-1" onClick={handleLinkClick}>Profiles</Link>
