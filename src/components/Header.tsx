        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gray-100">
            <div className="container mx-auto px-4 py-4 space-y-2">
              ...
              <Link to="/profiles" className="block text-gray-800 hover:text-blue-600" onClick={handleLinkClick}>
                Profiles
              </Link>
              <Link to="/net" className="block text-gray-800 hover:text-blue-600" onClick={handleLinkClick}>
                Net
              </Link>
              <Link to="/solar" className="block text-gray-800 hover:text-blue-600" onClick={handleLinkClick}>
                Solar Accessories
              </Link>
              <Link to="/dealers" className="block text-gray-800 hover:text-blue-600" onClick={handleLinkClick}>
                Dealers
              </Link>
              <Link to="/about" className="block text-gray-800 hover:text-blue-600" onClick={handleLinkClick}>
                About Us
              </Link>
              <Link to="/contact" className="block text-gray-800 hover:text-blue-600" onClick={handleLinkClick}>
                Contact
              </Link>
            </div>
          </div>
